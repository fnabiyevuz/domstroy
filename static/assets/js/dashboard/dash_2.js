    ...
    $(document).ready(function () {
        $.ajax({
            ...
            success: function (data) {
                ...
                var kirimd = data['kirimd'];
                var chiqims = data['chiqims'];
                var chiqimd = data['chiqimd'];
                // console.log(kirim)
                // console.log(chiqims)
                // console.log(chiqimd)
                var options1 = {
                    chart: {
                        ...
                        events: {
                            mounted: function (ctx, config) {
                                ...
                                ctx.addPointAnnotation({
                                    x: new Date(ctx.w.globals.seriesX[3][ctx.w.globals.series[3].indexOf(highest3)]).getTime(),
                                    y: highest3,
                                    label: {
                                        style: {
                                            cssClass: 'd-none'
        ...
        //         var qoldiq = data['qoldiq'];
        //         console.log(filial, qoldiq)
        //         var options = {
        //             chart: {
        //                 type: 'donut',
        //                 width: 380
...
//   series: [{
//       name: 'Income',
//       data: [17000, 16800, 15500, 17800, 15500, 17000, 19000, 16000, 15000, 17000, 14000, 17000]
//   }, {
//       name: 'Expenses',
